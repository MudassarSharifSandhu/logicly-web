...
const PatientDetail: React.FC = () => {
  ...
  var finalEoc = newDate.setDate(newDate.getDate() + 59);
  ...
  if (detail.recert != '') {
    ...
    var finalFiveWindow = fWindow.setDate(fWindow.getDate() - 4);
  ...
  if (detail.evaluation != "N/A") {
    if(detail.mostRecent30DRE != "N/A"){
      var initialEval = String(detail.mostRecent30DRE);
      const newEval = new Date(initialEval);
      var finalDRE = newEval.setDate(newEval.getDate() + 29);
